...
namespace iAssist.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult Login(string returnUrl, string s)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (users != null)
            {
                ...
                {
                    ViewBag.Confirm = "You must have a confirmed email to log on.";
                    return View(model);
                }
            }
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    else if(UserManager.IsInRole(user.Id, "Worker"))
                    {
                        return RedirectToAction("ViewUserRequestedTask", "Task");
                    }
                    else
                    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    ModelState.AddModelError("","Email Doesn`t exist or Email is not Confirmed");
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber = model.PhoneNumber, EmailConfirmed = true };
